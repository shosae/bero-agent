...
from app.modules.robot.services.navigation_service import NavigationBackend
...
class ExecutorService:
    ...
    @@현재 test를 위해 fallback을 success로 설정@@
    """
    ...
    def deliver_object(self, receiver: str | None = None) -> Dict[str, Any]:
        """
