"""Robot mission tool wrapper for the Master Agent."""

from __future__ import annotations

from langchain_core.tools import tool

from app.robot.body_graph import build_robot_body_graph
...
def robot_mission_tool(instruction: str) -> str:
    """
    물리적인 로봇 이동/관찰/배달이 필요할 때 호출합니다.
    LangGraph 기반 로봇 서브그래프를 실행합니다.
    """
    try:
